...
void calcularDieta(int peso, string sexo, int edad, double altura) {
    if (peso >= 45 && peso <= 65 && sexo == "m" && edad >= 12 && edad <= 14 && altura >= 1.45 && altura <= 1.65) {
        ...
        cout << "1 serving of complex carbohydrates (such as brown rice, quinoa, or whole wheat pasta)" << endl;
        cout << "afternoon snack:" << endl;
        cout << "1 serving of low-fat yogurt" << endl;
        cout << "1 serving of fresh fruit (such as grapes, peaches, or pears)" << endl;
        cout << "Dinner:" << endl;
        ...
        cout << "1 serving of complex carbohydrates (such as potatoes, sweet potatoes, or brown rice)" << endl;
        cout << "late night snack:" << endl;
        cout << "1 serving of fresh fruit (such as apples, grapes, or kiwis)" << endl;
        cout << "1 serving of nuts or seeds (such as walnuts, pistachios, or sunflower seeds)" << endl;
        ...
        cout << "1 serving of fresh fruit, such as an apple or banana" << endl;
        cout << "Morning snack:" << endl;
        cout << "1 low-fat yogurt or Greek yogurt with fresh fruit" << endl;
        cout << "Lunch:" << endl;
        ...
        cout << "1 serving of complex carbohydrates, such as brown rice, quinoa, or whole wheat pasta" << endl;
        cout << "afternoon snack:" << endl;
        cout << "1 serving of nuts or seeds, such as almonds, walnuts, or chia seeds" << endl;
        cout << "Dinner:" << endl;
        ...
        cout << "Mixed salad with fresh vegetables (such as lettuce, spinach, tomato and cucumber) dressed with olive oil and vinegar." << endl;
        cout << "late night snack:" << endl;
        cout << "1 serving of fresh fruit (such as apple, pear, or orange)." << endl;
        cout << "1 serving of walnuts or almonds." << endl;
        ...
        cout << "1 glass of water" << endl;
        cout << "Morning snack:" << endl;
        cout << "1 serving of fresh fruit, such as a banana or pear" << endl;
        cout << "1 handful of walnuts or almonds" << endl;
        cout << "Lunch:" << endl;
        cout << "1 serving of lean protein, such as grilled chicken, fish, or tofu" << endl;
        ...
        cout << "1 serving of fresh fruit, such as grapes or strawberries" << endl;
        cout << "Dinner:" << endl;
        cout << "1 serving of lean protein, such as lean meat, fish, or beans" << endl;
        ...
        cout << "1 glass of water" << endl;
        cout << "late night snack:" << endl;
        cout << "1 serving of fresh fruit, such as pineapple or cantaloupe" << endl;
    } else {
        cout << "No dietary recommendation was found for the entered data." << endl;
    }
}

void calcularRutina(int peso, string sexo, int edad, double altura) {
    if (peso >= 45 && peso <= 65 && sexo == "m" && edad >= 12 && edad <= 14 && altura >= 1.45 && altura <= 1.65) {
        cout << "Day 1: Strength exercises" << endl;
        ...
        cout << "Use an appropriate weight for your strength level." << endl;
        cout << "Day 2: Cardiovascular exercises" << endl;
        ...
        cout << "You can adjust the speed to make it a suitable challenge for you." << endl;
        cout << "3. Burpees: 3 series of 10 repetitions." << endl;
        cout << "Begin in a squat position, then bring your feet back to do a push-up, jump forward, and jump up with your arms extended." << endl;
        cout << "Day 3: Rest day or recreational activity" << endl;
        cout << "It is important to rest and allow your body to recover." << endl;
        cout << "You can take advantage of this day to do some recreational activity that you like, such as playing soccer, swimming or biking." << endl;
    } else if (peso >= 40 && peso <= 65 && sexo == "f" && edad >= 12 && edad <= 14 && altura >= 1.40 && altura <= 1.65) {
        cout << "Day 1: Cardio Training" << endl;
        ...
        cout << "3. Cool down: 5-10 minutes of light stretching." << endl;
        cout << "Day 2: Strength training" << endl;
        ...
        cout << "8. Cool down: 5-10 minutes of light stretching." << endl;
        cout << "Day 3: Active rest or recreational activity" << endl;
        cout << "1. Active rest: Bike ride, walk or gentle yoga to help recover from exercise and keep active." << endl;
        cout << "2. Recreational Activity: Participating in outdoor recreational activities such as playing soccer, skateboarding, or rollerblading." << endl;
        cout << "Day 4: Cardio Training" << endl;
        cout << "1. Warm up: 5-10 minutes of light cardiovascular activity." << endl;
        cout << "2. Cardiovascular Activity: 20-30 minutes of moderate cardiovascular activity such as running, biking, swimming, or playing sports such as soccer or basketball." << endl;
        cout << "3. Cool down: 5-10 minutes of light stretching." << endl;
        cout << "Day 5: Flexibility and balance trainingg" << endl;
        cout << "1. Warm up: 5-10 minutes of light cardiovascular activity." << endl;
        ...
        cout << "3. Balance exercises: Practice balance exercises, such as standing on one foot or doing yoga, to improve stability and coordination." << endl;
        cout << "4. Cool down: 5-10 minutes of light stretching." << endl;

    } else if (peso >= 66 && peso <= 80 && sexo == "m" && edad >= 15 && edad <= 20 && altura >= 1.66 && altura <= 1.90) {
        cout << "Day 1: Weight training routine (upper body)" << endl;
        ...
        cout << "7. Cable Triceps Extension: 3 sets of 10-12 reps" << endl;
        cout << "Day 2: Weight Training Routine (Lower Body)" << endl;
        ...
        cout << "5. Abdominals: 3 series of 15-20 repetitions (you can choose the abdominal exercise you prefer, such as crunches, Russian twists, etc.)" << endl;
        cout << "Day 3: Cardio Training Routine" << endl;
        ...
        cout << "4. Other cardiovascular activity of your choice, such as swimming, team sports, etc.: 30-40 minutes" << endl;
        cout << "Day 4: Active rest or yoga" << endl;
        ...
        cout << "Day 1: Strength training" << endl;
        ...
        cout << "1. Cool down: Static stretching of the main muscle groups for 5-10 minutes." << endl;
        cout << "Day 2: Cardio and interval training" << endl;
        ...
        cout << "5. Cool down: Dynamic and static stretching for 5-10 minutes." << endl;
        cout << "Day 3: Full Body Workout" << endl;
        ...
        cout << "9. Cool down: Static stretching for 5-10 minutes." << endl;
        cout << "Day 4: Active rest or low-intensity activity, such as yoga or easy walks." << endl;
}
